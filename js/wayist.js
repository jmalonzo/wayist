...
(function() {
  ...
  wayist.controller('ContentController', ["$scope", "$routeParams", "$http", "$location", "$anchorScroll", function ($scope, $routeParams, $http, $location, $anchorScroll) {
    var authorContent = [];
